...
extern "C" JNIEXPORT
void JNICALL Java_org_eva_pico_input_MainActivity_setNativeAssetManager(JNIEnv *env, jobject instance, jobject assetManager) {
    Java_com_picovr_openxr_MainActivity_setNativeAssetManager(env, instance, assetManager);
}
